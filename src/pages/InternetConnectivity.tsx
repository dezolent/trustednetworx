  ...
  return (
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-8 shadow-xl">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Ready to Transform Your Connectivity?</h3>
            <p className="text-lg text-blue-100 mb-8">
              Partner with us to transform your communication infrastructure, ensuring your business stays connected and competitive in today's fast-paced environment.
            </p>
            <Link
              to="/contact"
